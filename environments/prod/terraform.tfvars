# Shared variables for all stacks in aws-delos-prod.
# Pass with: terraform plan -var-file=../../../../environments/prod/terraform.tfvars
#
# Committed values are placeholders safe for a public repo.
# Replace 000000000000 / EXAMPLE_* with your own before apply.

env          = "prod"
account_name = "aws-delos-prod"
account_id   = "000000000000"
aws_profile  = "aws-delos-prod"
landscape    = "delos"
region       = "us-east-1"
region_short = "ue1"
